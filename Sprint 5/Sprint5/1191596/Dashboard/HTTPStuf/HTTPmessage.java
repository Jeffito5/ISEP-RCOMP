...
public class HTTPmessage {
    ...
    //First constructor
    //This constructor receives an HTTP message from a provided socket’s input stream, and store it in the newly created instance.
    public HTTPmessage(DataInputStream in) throws IOException {
        ...
        String[] headerLine =firstLine.split(" ");
        if(isRequest) {
